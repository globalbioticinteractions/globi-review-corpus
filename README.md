...
```
data.zip - the original files associated with the dataset under review along with the configuration needed for elton (a globi tool) to interpret them.
prov.nq - contains a data bill of materials expressed in machine readable rdf/quads text format
index.md - review report in markdown format
index.docx - review report in docx format
index.pdf - review report in docx format
interactions.csv.gz - a gzipped comma-separated values table with interaction records as interpreted by elton (a GloBI commandline tool)
names.csv.gz - a gzipped comma-separated values table with taxonomic names of interacting entities as interpreted by elton (a GloBI commandline tool)
review.csv.gz - a gzipped comma-separated values table with notes on the interaction dataset under review as generated by elton 
```
