...
The current anatomy of a GloBI review report is roughly as follows

 filename | description | example 
 --- | --- | ---
 data.zip | the original files associated with the dataset under review along with the configuration needed for elton (a globi tool) to interpret them | [https://zenodo.org/records/16415843/files/data.zip](https://zenodo.org/records/16415843/files/data.zip?download=1)
 prov.nq | contains a data bill of materials expressed in machine readable rdf/quads text format | [https://zenodo.org/records/16415843/files/prov.nq](https://zenodo.org/records/16415843/files/prov.nq?download=1)
 index.md | review report in markdown format | [https://zenodo.org/records/16415843/files/index.md](https://zenodo.org/records/16415843/files/index.md?download=1)
 index.docx | review report in docx format | [https://zenodo.org/records/16415843/files/index.docx](https://zenodo.org/records/16415843/files/index.docx?download=1)
 index.pdf | review report in docx format | [https://zenodo.org/records/16415843/files/index.pdf](https://zenodo.org/records/16415843/files/index.pdf?download=1)
 interactions.csv.gz | a gzipped comma-separated values table with interaction records as interpreted by elton (a GloBI commandline tool) | [https://zenodo.org/records/16415843/files/interactions.csv.gz](https://zenodo.org/records/16415843/files/interactions.csv.gz?download=1)
 names.csv.gz | a gzipped comma-separated values table with taxonomic names of interacting entities as interpreted by elton (a GloBI commandline tool) | [https://zenodo.org/records/16415843/files/names.csv.gz](https://zenodo.org/records/16415843/files/names.csv.gz?download=1)
 review.csv.gz | a gzipped comma-separated values table with notes on the interaction dataset under review as generated by elton | [https://zenodo.org/records/16415843/files/review.csv.gz](https://zenodo.org/records/16415843/files/review.csv.gz?download=1)

The dataset under review is uniquely identified by the cryptographic hash (or fixity/checksum/contentid) of their data bill of material. In this case, this is the md5 hash of the prov.nq file. To help make the dataset under review easier to identify, this md5 hash is included in the title of the GloBI data review.

For example, the review published in 
...
contains ```hash://md5/838ede23f4b8c6e8b7d692b61e954a60```, the md5 hash of the bill of materials of the dataset under review. In this case, the dataset associated with a desert foodweb dataset associated with:

> Eichenwald, A. J., Fefferman, N. H., & Reed, J. M. (2024). Potential extinction cascades in a desert ecosystem: Linking food web interactions to community viability. Ecology and Evolution, 14, e10930. https://doi.org/10.1002/ece3.10930 

## List Interactions

To list species interactions for a specific dataset under review (as identified by the md5 hash of their bill of material) you can run:
...
and inspect the file ```interactions.tsv``` for the interaction claims that elton extracted from the dataset under review.
